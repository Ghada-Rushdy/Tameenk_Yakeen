        ...
        {           
            ...
            try
            {
                driverData = new Citizen()
                {
                    ...
                    EnglishMiddleName = string.IsNullOrWhiteSpace(driverInfo.EnglishThirdName) ? "-" : driverInfo.EnglishThirdName,
                    ArabicLastName = driverInfo.LastName,
                    ArabicSecondName = string.IsNullOrWhiteSpace(driverInfo.SecondName) ? "-" : driverInfo.SecondName,
                    ArabicFirstName = driverInfo.FirstName,
                    ArabicMiddleName = string.IsNullOrWhiteSpace(driverInfo.ThirdName) ? "-" : driverInfo.ThirdName,
